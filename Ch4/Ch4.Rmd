...
$P(\theta=1|D=1)=\frac{99}{95049}=`r 99/95049`$ 

#### 4.3.C) Of those who tested positive on the first test, how many will be expected to test positive in the second test?


$p(D=1|\theta=1)= \frac{9900}{10000} = `r round(9900/10000,6)`$  
$p(D=0|\theta=1)= \frac{100}{10000} = `r round(100/10000,6)`$  
$p(D=1|\theta=0)= \frac{499500}{9990000} = `r round(499500/9990000,6)`$  
$p(D=0|\theta=0)= \frac{9490500}{9990000} = `r round(9490500/9990000,6)`$  
...
Assuming that the test and retest are independent, the total number of people who tested positive = `r 499500+9900`, $p(D=0|\theta=1)=0.01$, and $p(D=0|\theta=0)=0.95$, the total number of people expected to show negative results upon retesting is `r (499500*0.95)+(9900*0.01)`. 
